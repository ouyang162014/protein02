...
public class MzIdentMLUnmarshallerAdaptor extends MzIdentMLUnmarshaller {
    ...
    public Map<String, Map<String, List<IndexElement>>> scannedIdMappings;

    public Map<String, Map<String, List<IndexElement>>> getScannedIdMappings() {
		return scannedIdMappings;
	}
